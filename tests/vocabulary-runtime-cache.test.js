...
test('service worker ships a v67 schema-compatible runtime artifact set', () => {
...
test('service worker serves the v67 artifact from cache while offline and removes v54', async () => {
    ...
    const caches = {
        ...
        match: async request => cacheStores.get('rutr-v67')?.get(requestKey(request)) || null,
