...
test('service worker ships a v70 schema-compatible runtime artifact set', () => {
...
test('service worker serves the v70 artifact from cache while offline and removes v54', async () => {
    ...
    const caches = {
        ...
        match: async request => cacheStores.get('rutr-v70')?.get(requestKey(request)) || null,
